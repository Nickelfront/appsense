...
// $templateFileName = "";
// if ($user->get("user_type") == "Business owner") {
//     $templateFileName = "business-owner-dashboard.php";
// } else {
//     $templateFileName = "employee-home.php";
// }

// echo(Template::content($templateDir, $templateFileName));
?>
